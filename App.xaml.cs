...
namespace LocalContacts
{
    public partial class App : Application
    {
        ...
        public StorageFile ReadFile { get; set; }
        ...
        /*
                ...
                public FileOpenPickerUI FileOpenPickerUI { get; set; }
                */
        /// <summary>
        ...
        private void Application_ContractActivated(object sender, IActivatedEventArgs e)
        {
            ...
            app.aborted = false;
            if (e as FileOpenPickerContinuationEventArgs != null)
            {
                var filePickerContinuationArgs = e as FileOpenPickerContinuationEventArgs;
                if (filePickerContinuationArgs.Files.Count > 0)
                {
                    Debug.WriteLine("Data is " + filePickerContinuationArgs.Files[0].Name);
                    app.ReadFile = filePickerContinuationArgs.Files[0];
                }
                else
                {
                    app.aborted = true;
            ...
            else if (e as FileSavePickerContinuationEventArgs != null)
            {
                var filePickerContinuationArgs = e as FileSavePickerContinuationEventArgs;
                if (filePickerContinuationArgs.File != null)
                {
                    Debug.WriteLine("Data is " + filePickerContinuationArgs.File.ToString());
                    app.SaveFile = filePickerContinuationArgs.File;
                }
                else
                {
                    app.aborted = true;
